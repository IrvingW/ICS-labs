...
int dstE = [
	...
	icode in { IIRMOVL, IOPL, IIADDL } : rB; #M
	icode in { IPUSHL, IPOPL, ICALL, IRET, ILEAVE } : RESP; #M
...
int aluA = [
	...
	icode in { IIRMOVL, IRMMOVL, IMRMOVL, IIADDL } : valC; #M
	icode in { ICALL, IPUSHL } : -4;
	icode in { IRET, IPOPL, ILEAVE } : 4; #M
...
int aluB = [
	icode in { IRMMOVL, IMRMOVL, IOPL, ICALL, 
		      IPUSHL, IRET, IPOPL, IIADDL, ILEAVE } : valB; #M
...
bool set_cc = icode in { IOPL, IIADDL }; # does this need to be modified

################ Memory Stage    ###################################

## Set read control signal
bool mem_read = icode in { IMRMOVL, IPOPL, IRET, ILEAVE }; #M
...
int mem_addr = [
	...
	icode in { IPOPL, IRET, ILEAVE } : valA; #M
